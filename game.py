...
class Level:
	def __init__ (self, coords, colour, bg_colour, shadow_colour):
		self.colour = colour
		self.bg_colour = bg_colour
		self.shadow_colour = shadow_colour
		self.blocks = []
		for i in range(len(coords)):
			self.blocks.append(Block(coords[i]))
...
level1 = Level(level1_blocks, level1_colour, level1_bg_colour, level1_shadow_colour)
active_level = level1

...
class Ball:
	...
	def speedup_collision (self):
		...
		for speedup in active_level.speedup:
				...
				np_speedup = np.asarray([speedup.pos[0] + speedup.rect.center[0], speedup.pos[1] + speedup.rect.center[1]])
	...
	def invert_collision (self):
		...
		for invert in active_level.invert:
				...
				np_invert = np.asarray([invert.pos[0] + invert.rect.center[0], invert.pos[1] + invert.rect.center[1]])
	...
	def freeze_collision (self):
		...
		for freeze in active_level.freeze:
				...
				np_freeze = np.asarray([freeze.pos[0] + freeze.rect.center[0], freeze.pos[1] + freeze.rect.center[1]])
...
level1 = Level(level1_blocks, level1_holes, level1_colour, level1_bg_colour, level1_edge_colour, level1_goal_colour, level1_speedup, level1_invert, level1_freeze)
...
level2 = Level(level2_blocks, level2_holes, level2_colour, level2_bg_colour, level2_edge_colour, level2_goal_colour, level2_speedup, level2_invert, level2_freeze)
...
level3 = Level(level3_blocks, level3_holes, level3_colour, level3_bg_colour, level3_edge_colour, level3_goal_colour, level3_speedup, level3_invert, level3_freeze)
...
level4 = Level(level4_blocks, level4_holes, level4_colour, level4_bg_colour, level4_edge_colour, level4_goal_colour, level4_speedup, level4_invert, level4_freeze)
...
level5 = Level(level5_blocks, level5_holes, level5_colour, level5_bg_colour, level5_edge_colour, level5_goal_colour, level5_speedup, level5_invert, level5_freeze)
